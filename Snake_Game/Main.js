...
(function (Snake_Game) {
    ...
    let snakeGame = new ƒ.Node("SnakeGame");
    let direction = new ƒ.Vector3(1, 0, 0);
    let snakePrevSegment;
    let cmpCamera = new ƒ.ComponentCamera();
    //let snakeGame: ƒ.Node;
    function hndLoad(_event) {
        const canvas = document.querySelector("canvas");
        Snake_Game.snake = new Snake_Game.Snake();
        Snake_Game.snakeFood = new Snake_Game.SnakeFood();
        snakeGame.appendChild(Snake_Game.snake);
        snakeGame.appendChild(Snake_Game.snakeFood);
        ...
        Snake_Game.viewport.initialize("Viewport", snakeGame, cmpCamera, canvas);
        ƒ.Loop.addEventListener("loopFrame" /* LOOP_FRAME */, update);
        ƒ.Loop.start(ƒ.LOOP_MODE.TIME_REAL, 1);
    }
    function update(_event) {
        Snake_Game.snake.move(direction);
        Snake_Game.snakeFood.checkIfFoodWasEaten();
        ...
        */
        if (Snake_Game.snake.getChildren()[0].mtxWorld.translation.x > 0 && Snake_Game.snake.getChildren()[0].mtxWorld.translation.y < 0) {
    ...
    function keyPressed(_event) {
        snakePrevSegment = Snake_Game.snake.getChildren()[0].mtxWorld;
        switch (_event.code) {
            case ƒ.KEYBOARD_CODE.W:
                snakePrevSegment.translate(new ƒ.Vector3(0, 1, 0));
                if (snakePrevSegment.translation.y == Snake_Game.snake.getChildren()[1].mtxWorld.translation.y) {
                    break;
                }
            ...
            case ƒ.KEYBOARD_CODE.A:
                ...
                if (snakePrevSegment.translation.x == Snake_Game.snake.getChildren()[1].mtxWorld.translation.x) {
                    break;
                }
    ...
    function createGround() {
        let ground1 = new ƒ.Node("GroundCube_1");
        let ground2 = new ƒ.Node("GroundCube_2");
        let ground3 = new ƒ.Node("CenterCube_3");
        let ground4 = new ƒ.Node("CenterCube_4");
        let ground5 = new ƒ.Node("CenterCube_5");
        let meshCube = new ƒ.MeshCube();
        let mtrSolidSkyGrey = new ƒ.Material("SolidGrey", ƒ.ShaderUniColor, new ƒ.CoatColored(ƒ.Color.CSS("DIMGRAY")));
        let mtrSolidSkyGrey2 = new ƒ.Material("SolidGrey", ƒ.ShaderUniColor, new ƒ.CoatColored(ƒ.Color.CSS("SLATEGRAY")));
        let mtrSolidSkyGrey3 = new ƒ.Material("SolidGrey", ƒ.ShaderUniColor, new ƒ.CoatColored(ƒ.Color.CSS("midnightblue")));
        ...
        let cmpMaterial1 = new ƒ.ComponentMaterial(mtrSolidSkyGrey);
        let cmpMaterial2 = new ƒ.ComponentMaterial(mtrSolidSkyGrey);
        let cmpMaterial3 = new ƒ.ComponentMaterial(mtrSolidSkyGrey2);
        let cmpMaterial4 = new ƒ.ComponentMaterial(mtrSolidSkyGrey2);
        let cmpMaterial5 = new ƒ.ComponentMaterial(mtrSolidSkyGrey3);
